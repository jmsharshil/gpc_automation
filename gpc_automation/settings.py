"""
Django settings for gpc_automation project.
...
SECRET_KEY = 'django-insecure-d!-t&!5j1u7r+6gt938@r-y8mdz=fttnhs$!r^hrjwdvf9aht6'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = False

ALLOWED_HOSTS = ['gpcautomation-hbedaghhb8ffctep.centralindia-01.azurewebsites.net','gpcauto.s3-website.ap-south-1.amazonaws.com','gpcautomation.s3-website.ap-south-1.amazonaws.com','localhost','127.0.0.1','gpc-h0eth6gagwh3f3ad.centralindia-01.azurewebsites.net']
...
ROOT_URLCONF = 'gpc_automation.urls'
...
WSGI_APPLICATION = 'gpc_automation.wsgi.application'
...
MICROSOFT_OAUTH_TENANT_ID = os.environ.get('MICROSOFT_OAUTH_TENANT_ID')
MICROSOFT_OAUTH_REDIRECT_URI = os.environ.get('MICROSOFT_OAUTH_REDIRECT_URI', 'http://localhost:8000/auth/microsoft/callback/')
